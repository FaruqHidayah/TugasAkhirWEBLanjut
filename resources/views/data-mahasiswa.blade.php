...
<table style="text-align:left ;border:1px solid;border-collapse: collapse;">
    <tr>
        ...
        <th style="border:1px solid; padding : 10px; text-allign:center">Foto</th>
...
@foreach ($mahasiswa as $mhs)
    <tr>
        ...
        <td style="border:1px solid; padding : 10px; text-allign:center">{{$mhs->nama}}</td>
        ...
        <td style="border:1px solid; padding : 10px; text-allign:center"><img src="{{asset('gambar/' .$mhs->foto)}}" alt="sembarang" style="width: 60px"></td>
        <td>
